...
//     var sum = _.reduce([1, 2, 3], callback, 2);
...
//   it("it should multiply each item in the array and with an initial value", function() {
//     var callback = function(sum, num) {return sum * num;};
//     var sum = _.reduce([2, 4, 8], callback, 1);
//     expect(sum).to.equal(64);
//   });
